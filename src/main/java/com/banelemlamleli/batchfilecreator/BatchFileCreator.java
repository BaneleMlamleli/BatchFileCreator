 ...
 *
 * <p>
 * Swing-based GUI application that builds "batch" test data sets and writes
 * them
 ...
 * scenarios.</li>
 * <li>Call DBConnection helper methods
 * (DBConnection.getAlertOrNoAlertMasterPartyOnly
 ...
 * when appropriate.</li>
 * <li>Present informational and error messages to the user via
 * JOptionPane.</li>
 * </ul>
 *
 * <p>
 * <b>Important implementation notes / side effects</b>
 * </p>
 * <ul>
...
public class BatchFileCreator extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger
            .getLogger(BatchFileCreator.class.getName());
    ...
    private void btnDownloadTxtFileActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDownloadTxtFileActionPerformed
        ...
        int cmbNp_NaturalPersonMasterParty = Integer
                .parseInt(cmbNP_NaturalPersonMasterParty.getSelectedItem().toString());
        ...
        // ArrayList that will store the complete information that will be written into
        // a batch file
            ...
            switch (cmbLe_LEWhichPartyMustAlert) {
                case "None":
                    ...
                    for (int l = 0; l < cmbLe_LegalEntityMasterParty; l++) {
                        List<Party> tempList = DBConnection.getAlertOrNoAlertMasterPartyOnly(false, "L", productType,
                                riskClass, businessUnit);
                        ...
                        if (cmbLe_LELinkedParty != 0) {
                            for (int e = 0; e < cmbLe_LELinkedParty; e++) {
                                completeBatchFileData.add(DBConnection.getAlertOrNoAlertLinkedPartyOnly(false, "L",
                                        productType, riskClass, businessUnit, masterPartyAccountNumber));
                            }
                        }

                        // Loop through the natural person linked party for the Legal Entity master
                        // party
                        if (cmbLe_NPLinkedParty != 0) {
                            for (int e = 0; e < cmbLe_NPLinkedParty; e++) {
                                completeBatchFileData.add(DBConnection.getAlertOrNoAlertLinkedPartyOnly(false, "P",
                                        productType, riskClass, businessUnit, masterPartyAccountNumber));
                            }
                        }
                    ...
                    if (cmbLe_LEMasterParty != 0) {
                        for (int e = 0; e < cmbLe_LEMasterParty; e++) {
                            completeBatchFileData.add(DBConnection.getAlertOrNoAlertMasterPartyOnly(false, "L",
                                    productType, riskClass, businessUnit));
                        }
                    }
                    ...
                    if (cmbLe_NPMasterParty != 0) {
                        for (int e = 0; e < cmbLe_NPMasterParty; e++) {
                            completeBatchFileData.add(DBConnection.getAlertOrNoAlertMasterPartyOnly(false, "P",
                                    productType, riskClass, businessUnit));
                        }
                    }
                    ;
                ...
                case "All parties":
                    // loop through the Legal entity master party
                    for (int l = 0; l < cmbLe_LegalEntityMasterParty; l++) {
                        List<Party> tempList = DBConnection.getAlertOrNoAlertMasterPartyOnly(true, "L", productType,
                                riskClass, businessUnit);
                        completeBatchFileData.add(tempList);
                        String masterPartyAccountNumber = tempList.get(0).getAccount_number();
                        ...
                        if (cmbLe_LELinkedParty != 0) {
                            for (int e = 0; e < cmbLe_LELinkedParty; e++) {
                                completeBatchFileData.add(DBConnection.getAlertOrNoAlertLinkedPartyOnly(true, "L",
                                        productType, riskClass, businessUnit, masterPartyAccountNumber));
                            }
                        }
                        ...
                        if (cmbLe_NPLinkedParty != 0) {
                            for (int e = 0; e < cmbLe_NPLinkedParty; e++) {
                                completeBatchFileData.add(DBConnection.getAlertOrNoAlertLinkedPartyOnly(true, "P",
                                        productType, riskClass, businessUnit, masterPartyAccountNumber));
                            }
                        }
                    ...
                    if (cmbLe_LEMasterParty != 0) {
                        for (int e = 0; e < cmbLe_LEMasterParty; e++) {
                            completeBatchFileData.add(DBConnection.getAlertOrNoAlertMasterPartyOnly(true, "L",
                                    productType, riskClass, businessUnit));
                        }
                    }
                    ...
                    if (cmbLe_NPMasterParty != 0) {
                        for (int e = 0; e < cmbLe_NPMasterParty; e++) {
                            completeBatchFileData.add(DBConnection.getAlertOrNoAlertMasterPartyOnly(true, "P",
                                    productType, riskClass, businessUnit));
                        }
                    }
                    ;
                ...
                case "Linked parties":
                    if (cmbLe_LELinkedParty >= 1 && cmbLe_NPLinkedParty >= 1) {
                        // loop through the Legal entity master party
                        for (int l = 0; l < cmbLe_LegalEntityMasterParty; l++) {
                            List<Party> tempList = DBConnection.getAlertOrNoAlertMasterPartyOnly(false, "L",
                                    productType, riskClass, businessUnit);
                            completeBatchFileData.add(tempList);
                            String masterPartyAccountNumber = tempList.get(0).getAccount_number();
                        ...
                        JOptionPane.showMessageDialog(null, "Both linked parties must have a value more than zero",
                ...
                case "One LE linked party":
                    if (cmbLe_LELinkedParty != 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Legal Entity linked party must have a value more than zero", "Error",
                ...
                case "One NP linked party":
                    if (cmbLe_NPLinkedParty != 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Natural person linked party must have a value more than zero", "Error",
                                JOptionPane.ERROR_MESSAGE);
                    }
                    ;
                    break;
            ...
            switch (cmbNp_NPWhichPartyMustAlert) {
                case "None":
                    ...
                    for (int l = 0; l < cmbNp_NaturalPersonMasterParty; l++) {
                        List<Party> tempList = DBConnection.getAlertOrNoAlertMasterPartyOnly(false, "P", productType,
                                riskClass, businessUnit);
                        completeBatchFileData.add(tempList);
                        String masterPartyAccountNumber = tempList.get(0).getAccount_number();
                ...
                case "All parties":
                    // loop through the Legal entity master party
                    for (int l = 0; l < cmbNp_NaturalPersonMasterParty; l++) {
                        List<Party> tempList = DBConnection.getAlertOrNoAlertMasterPartyOnly(true, "P", productType,
                                riskClass, businessUnit);
                        completeBatchFileData.add(tempList);
                        String masterPartyAccountNumber = tempList.get(0).getAccount_number();
                ...
                case "Linked parties":
                    if (cmbNp_LELinkedParty >= 1 && cmbNp_NPLinkedParty >= 1) {
                        // loop through the Legal entity master party
                        for (int l = 0; l < cmbNp_NaturalPersonMasterParty; l++) {
                            List<Party> tempList = DBConnection.getAlertOrNoAlertMasterPartyOnly(false, "P",
                                    productType, riskClass, businessUnit);
                            completeBatchFileData.add(tempList);
                            String masterPartyAccountNumber = tempList.get(0).getAccount_number();
        ...
        try {
            ...
            // Prefer standard ~/Downloads (or %USERPROFILE%\Downloads). Fallback to
            // src/main/resources.
            ...
            // Also, if we fell back to using Downloads but the project resource file
            // exists, delete it too.
            ...
            JOptionPane.showMessageDialog(null, "Error deleting existing txt: " + ex.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
        ...
        for (int i = 0; i < completeBatchFileData.size(); i++) {
            for (int j = 0; j < completeBatchFileData.get(i).size(); j++) {
                // System.out.println("Index: " + i + ", Party account number: " +
                // completeBatchFileData.get(i).get(j).getAccount_number());
                ...
                try {
                    ...
                    // Prefer standard ~/Downloads (or %USERPROFILE%\Downloads). Fallback to user
                    // home.
                    if (Files.exists(downloadsDir) && Files.isDirectory(downloadsDir)) {
                        completeDataFilePath = downloadsDir.resolve("completeDataForBatchFile.txt");
                    } else {
                    ...
                    logger.log(java.util.logging.Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(null, "Error writing txt: " + ex.getMessage(), "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
        }
        ...
        if (completeBatchFileData.size() != 0) {
            JOptionPane.showMessageDialog(null,
                    "YOUR FILE IS DOWNLOADED IN THE BELOW DIRECTORY:\n" + completeDataFilePath.toString());
        }
    ...
    private void cmbProductTypeActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmbProductTypeActionPerformed
        ...
        int riskValue = Integer
                .parseInt(cmbProductType.getSelectedItem().toString().substring(lengthOfProductType - 1));
    ...
    private void btnDownloadCsvFileActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDownloadCsvFileActionPerformed
        ...
        try {
            ...
            logger.log(java.util.logging.Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Error deleting existing CSV: " + ex.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
        ...
        for (int i = 0; i < completeBatchFileData.size(); i++) {
            for (int j = 0; j < completeBatchFileData.get(i).size(); j++) {
                ...
                try {
                    ...
                    logger.log(java.util.logging.Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(null, "Error writing CSV: " + ex.getMessage(), "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
        }
